export default function decorate(block) {
  ...
  [...block.children].forEach((row)=>{
    ...
    if(row.children.length ===1){
        ...
        const imgWrapper = pic.querySelector('img'); 
        imgWrapper.className = 'tw-transition-all tw-duration-500 tw-inset-0 tw-top-0 tw-left-0 tw-w-full tw-h-full tw-object-cover hover:tw-scale-[1.05] motion-reduce:hover:tw-transform-none';
